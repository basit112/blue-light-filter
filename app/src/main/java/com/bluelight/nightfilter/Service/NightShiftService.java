package com.bluelight.nightfilter.Service;

import static com.bluelight.nightfilter.Utils.Const.NOTIFICATION_ID;
...
import com.bluelight.nightfilter.Broadcast.NightModeReceiver;
import com.bluelight.nightfilter.Listener.IClickSetTimer;
import com.bluelight.nightfilter.Listener.IShowNotification;
import com.bluelight.nightfilter.Utils.Commom;
import com.bluelight.nightfilter.activity.MainActivity;
...
import com.bluelight.nightfilter.Utils.CustomNotification;
...
public class NightShiftService extends Service implements IShowNotification, IClickSetTimer {
    ...
    private final BroadcastNightShift broadcastNightShift = new BroadcastNightShift();

    //Flashlight
    private Camera camera;
    private Camera.Parameters parameters;
//    private static final String NOTIFICATION_CHANNEL_ID = "night_shift_channel_id";
...
//            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "Night Shift Service", NotificationManager.IMPORTANCE_LOW);
...
//                    .setContentTitle("Night Shift Service")
            ...
            switch (intent.getAction()) {
                ...
                case Const.ACTION_FLASH_LIGHT:
                    if (!Commom.isFlashlightAvailable(context)) {
                        Toast.makeText(context, "Flash light not available in your device", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    private void changedRing() {
        switch (audioManager.getRingerMode()) {
            case AudioManager.RINGER_MODE_NORMAL:
                ...
                startForeground(NOTIFICATION_ID, CustomNotification.getmBuilder().build());
